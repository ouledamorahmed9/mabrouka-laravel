    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <h3 class="text-2xl font-serif font-semibold text-amber-300 mb-4">Mabrouka Fashion</h3>
                <p class="text-gray-400 max-w-lg">
                    Spécialistes de la location et de la vente de robes traditionnelles tunisiennes haut de gamme. Nous allions savoir-faire artisanal et design moderne pour sublimer vos plus belles occasions.
                </p>
            </div>
