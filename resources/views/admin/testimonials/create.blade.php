...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 p-6">
    <div class="container mx-auto px-6 py-8">
        <div class="flex justify-between items-center mb-6">
            <h3 class="text-gray-700 text-3xl font-medium">Ajouter un nouveau témoignage</h3>
        ...
        <div class="mt-8">
            <div class="mt-4">
                <div class="p-6 bg-white rounded-md shadow-md">
                    <h2 class="text-lg text-gray-700 font-semibold capitalize mb-6">Formulaire d'ajout</h2>
                    ...
                    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select id="rating" name="rating" required
                                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring">
                                    <option value="5" {{ old('rating', 5) == 5 ? 'selected' : '' }}>★★★★★ (5 étoiles)</option>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="content" name="content" rows="5" required
                                      class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring">{{ old('content') }}</textarea>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <span class="text-xs text-gray-500">Formats acceptés : JPG, PNG, WEBP. Max 2 Mo.</span>
                        </div>
